...
class BookingModel extends Equatable {
  ...
  bool get canCancel => DateTime.now().isBefore(
    _timeOn(startTime).subtract(const Duration(minutes: 5)),
  );
  ...
  BookingModel copyWith({
    ...
    return BookingModel(
      ...
      partnerName: partnerName == _sentinel
          ? this.partnerName
      ...
      courtAddress: courtAddress == _sentinel
          ? this.courtAddress
